...
def search_company(company_name):
    ...
    response = requests.get(url, headers=headers) # response is variable name , requests.get(url)--> it is telling that go to url and get the data
...
while True:
    ...
    if ticker_result == "ERROR":
        ...
        break
    elif ticker_result is None:
        print("No ticker found! Try again")
    else:
